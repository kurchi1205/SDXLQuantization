swift run StableDiffusionSample "A dog running on the highway" --resource-path ml_package_sdxl_swift/Resources --output-path swift_results --compute-units cpuAndNeuralEngine --xl --seed 28 --step-count 30
