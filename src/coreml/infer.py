...
from diffusers import StableDiffusionPipeline, StableDiffusionXLPipeline, AutoPipelineForImage2Image
...
def main(args):
    ...
    if 'xl' in args.model_version and args.image2image:
        SDP = AutoPipelineForImage2Image
